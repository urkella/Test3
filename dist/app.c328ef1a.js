...
exports.getRocketById = exports.API = void 0;

var _axios = _interopRequireDefault(require("axios"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var API = "https://api.spacexdata.com/v4";
exports.API = API;

var getInfo = function getInfo() {
  _axios.default.get("".concat(API, "/company")).then(function (res) {
    ...
    createHeadquarters.innerHTML = "".concat(res.data.headquarters.city, ", ").concat(res.data.headquarters.state, ", ").concat(res.data.headquarters.address);
...
var getNextLaunch = function getNextLaunch() {
  _axios.default.get("".concat(API, "/launches/next")).then(function (res) {
    ...
    createNextLaunchName.innerHTML = "Mission name: ".concat(res.data.name); // Img attributes
...
var starLinkRockets = function starLinkRockets() {
  _axios.default.get("".concat(API, "/starlink")).then(function (res) {
    var r = res.data;
    var selector = document.getElementById("allStarLinks");
    var select = document.getElementById("star");
    var findAvailableVersions = res.data.filter(function (v, i, a) {
      return a.findIndex(function (t) {
        return t.version === v.version;
      }) === i;
    });
    findAvailableVersions.map(function (i) {
    ...
    for (var property in r) {
      ...
      starLink.innerHTML = "Name: ".concat(r[property].spaceTrack.TLE_LINE0, ", Version: ").concat(r[property].version);
...
selectElement.addEventListener("change", function (event) {
  ...
  s.innerHTML = "";
  var r = starlinks.filter(function (i) {
    return i.version === event.target.value;
  });
  r.map(function (i) {
    var newStarLink = document.createElement("li");
    newStarLink.innerHTML = "Name: ".concat(i.spaceTrack.TLE_LINE0, ", Version: ").concat(i.version);
    s.append(newStarLink);
  });
});

var getRocketById = function getRocketById(id) {
  _axios.default.get("".concat(API, "/rockets/").concat(id)).then(function (res) {
    ...
    createRocketName.innerHTML = "Rocket name: ".concat(res.data.name); // Img attributes
...
exports.getRocketById = getRocketById;
